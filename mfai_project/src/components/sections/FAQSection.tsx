...
const faqs = [
  ...
  {
    question: "How is MFAI different from a platform or a Synaptic Governance™?",
    answer:
      "We're not a platform. We're not a Synaptic Governance™. We are a protocol — one that activates on-chain proof of contribution, learning, and project building through a dynamic activation loop."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Zyno is your AI Co-Founder. It tracks your growth, recommends paths, helps design your token strategy, and prepares you for Synaptic Governance™ participation."
  }
];
