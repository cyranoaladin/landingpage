...
const steps = [
  ...
  },
  {
    icon: Wrench,
    title: "Build",
    text: "Launch your idea using guided canvases and Synaptic Governance™-powered templates. Collaborate, prototype, and publish your Proof-of-Vision profile. Build what you want to own."
  },
  {
    icon: CheckCircle,
    title: "Prove",
  ...
  },
  {
    icon: Rocket,
    title: "Activate",
    text: "Submit your project to the Proof-of-Vision Incubator™. Get Synaptic Governance™ support, Zyno optimization, and capital injection via $MFAI. Your proof becomes value."
  },
  {
    icon: Globe,
    title: "Scale",
