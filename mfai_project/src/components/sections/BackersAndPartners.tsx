...
const poweredBy = [
  {
    ...
    tooltip: "Building on Solana's high-performance blockchain for sovereign builders"
  },
  {
    name: "Metaplex",
    logo: "/images/partners/metaplex.png",
    description: "Proof-of-Skill Token™ infrastructure",
    tooltip: "Leveraging Metaplex for Proof-of-Skill Token™ membership passes"
  },
  {
    name: "Google Cloud",
    logo: "/images/partners/google-cloud.webp",
    description: "Zyno AI Co-Founder™ backend & APIs",
    tooltip: "Powered by Google Cloud's AI infrastructure for cognitive activation"
  },
  {
    name: "Solana Pay",
    logo: "/images/partners/solana-pay.svg",
    description: "Web3 payment integration",
    tooltip: "Seamless Proof-of-Skill Token™ checkout experience"
  },
  {
    name: "Zealy",
    logo: "/images/partners/zealy.jpeg",
    description: "Skillchain Mining™ engagement",
    tooltip: "Gamified Skillchain Mining™ on Zealy"
  }
];
...
const integratedWith = [
  {
    ...
    tooltip: "Planned integration post-TGE for sovereign builders"
  },
  {
    name: "Raydium",
    logo: "/images/partners/raydium.svg",
    description: "Targeted for listing",
    tooltip: "Planned listing post-token launch for protocol-aligned ventures"
  },
  {
    name: "Blink",
    logo: "/images/partners/blinksonsolana.png",
    description: "Solana checkout integration",
    tooltip: "Streamlined payment processing for Skillchain Mining™"
  },
  {
    name: "Rainbow",
    logo: "/images/partners/rainbow.png",
    description: "Wallet integration",
    tooltip: "Seamless on-chain wallet experience for sovereign builders"
  },
  {
    name: "DexTools",
    logo: "https://i.ibb.co/HLwfkv4n/dextools-icon-filled-3342522106-removebg-preview.png",
    description: "Real-time market analytics",
    tooltip: "Token charts and liquidity data for protocol-aligned ventures"
  },
  {
    name: "CoinGecko",
    logo: "https://i.ibb.co/Nd91JkRJ/1-MNU7n-Mmomuk3xc2-S2-Jw08-Q-1068178862.png",
    description: "Token tracking",
    tooltip: "Real-time token data via CoinGecko API for sovereign builders"
  }
];
...
const recognizedBy = [
  {
    ...
    tooltip: "Supported via grant program for protocol-aligned ventures"
  },
  {
    name: "Colosseum",
    logo: "/images/partners/colesseum.webp",
    description: "Hackathon participation",
    tooltip: "Active participant in Solana hackathons for sovereign builders"
  },
  {
    name: "Bizthon Hackathon",
    logo: "/images/partners/bizthon.png",
    description: "Solana Track - Hackathon PBW 2025",
    tooltip: "Participated in Bizthon's Solana hackathon during PBW (6-7 April 2025) for protocol-aligned ventures"
  },
  {
    name: "PBW 2025",
    logo: "/images/partners/pbw.jpg",
    description: "Paris Blockchain Week (8-10 April)",
    tooltip: "Invited as Pro Devs to PBW 2025 — ecosystem showcase & networking for sovereign builders"
  },
  {
    name: "Codigo",
    logo: "/images/partners/codigo_logo.svg",
    description: "Beta testing & workshop",
    tooltip: "Beta tester access via workshop for Skillchain Mining™"
  }
];
...
const tscopPartner = {
  ...
  description: "Ensuring protocol security, smart contract audits, regulatory compliance, and legal framework alignment for the Cognitive Activation Protocol™. Your trusted partner for blockchain security and compliance.",
  tooltip: "Smart contract audit, blockchain compliance & legal monitoring for sovereign builders"
};
    ...
    <TooltipProvider>
      <section className="py-16 md:py-24 bg-gradient-to-b from-[#0B0B0F] to-[#181825]">
        <div className="container mx-auto px-4">
          ...
          >
            Cognitive Activation Protocol™ Infrastructure
          </motion.h2>
          ...
          >
            Powered by Cognitive Activation Protocol™
          </motion.h3>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="w-32 h-32 md:w-40 md:h-40 flex items-center justify-center mb-4 bg-[#181825]/40 rounded-xl p-5 border border-white/5 group-hover:border-[#14F195]/30 transition-all duration-300">
                      <Image
                        ...
                        width={80}
                        height={80}
                        className="object-contain filter drop-shadow-[0_0_8px_rgba(20,241,149,0.3)]"
                      />
                    </div>
          ...
          <motion.h3
            ...
            className="text-xl md:text-2xl lg:text-3xl font-orbitron font-bold text-center mb-2"
          >
            Integrated with the Cognitive Activation Protocol™
          </motion.h3>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="mt-16 md:mt-24">
            <motion.h3
              ...
              className="text-xl md:text-2xl lg:text-3xl font-orbitron font-bold text-center mb-2"
            >
              Recognized by the Sovereign Builder Community
            </motion.h3>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              From grants and hackathons to token tracking — our journey is supported by respected players in the Cognitive Activation Protocol™ ecosystem.
            </motion.p>
